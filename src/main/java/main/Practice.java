...
public class Practice {
    ...
    public static double countRequirement(int[] scores) {
        int endIndex = scores[scores.length - 1];
        int firstIndex = scores[0];
        int sum = endIndex + firstIndex;
    ...
    public static boolean isShipAbleToFight(int shieldCharge, int weaponCharge) {
        double atlagos = (double) (shieldCharge + weaponCharge) / 2;
        if (shieldCharge > 20 && weaponCharge > 20 && atlagos > 50) {
            return true;
        } else {
